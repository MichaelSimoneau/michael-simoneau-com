...
export const blogData: BlogData[] = [
  ...
  },
  {
    ...
    subtitle: "How a Systems Engineer Out-Modeled Clinical Psychology",
    excerpt:
    ...
    content: [
      ...
      // --- 2. Einstein's Habits vs. Michael's Solar: The Support Myth ---
      createHeading("Einstein's Habits vs. Michael's Solar: The Support Myth", 2),
      createParagraph(
      ...
      createParagraph(
        "Einstein famously embraced unconventional personal habits and rigid routines. Those traits are romanticized as \"cute\" because he had a support structure to absorb his daily logistical friction. When Simoneau exhibits similar traits—such as the \"Dirty Dish\" dependency chain—he is pathologized."
      ),
      createCallout(
        "\"Einstein had the support structure that I lack. He could be eccentric and everyone called it genius. But when I do similar things, it's treated as a pathology. He had family. He had support. I use the tools I have: AI and therapy.\""
      ),
      createParagraph(
      ...
      createParagraph(
        "This system is not driven by desperation; it runs on physical infrastructure called the **Sovereign Organism**. Simoneau has achieved **Energy Zero** through a solar array (10 panels, 12 batteries) secured through equipment trades."
      ),
