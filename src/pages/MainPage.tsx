    ...
    () => [
      {
        ...
        description:
          'From enterprise architecture at JPMorgan and StoneX to building The Human Dollar (#THD). Money is an employee — $366 for every $1 put to work at the 36,636 cap. Stagnation is a firing offense. Built on Zeroth Theory, Crypto Fabric, and The Human Dollar.',
        inLanguage: 'en-US',
        ...
        mainEntity: [
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Michael Simoneau is a technologist and systems architect who evolved from enterprise architecture at JPMorgan Chase and StoneX into building The Human Dollar (#THD). Money is an employee — $366 for every $1 put to work at the 36,636 cap. Stagnation is a firing offense. Built on Zeroth Theory, Crypto Fabric, and The Human Dollar.',
            },
          },
          {
            '@type': 'Question',
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'The Human Dollar (#THD) is an economic architecture designed by Michael Simoneau. Money is an employee — put it to work and it pays $366 for every $1 at the 36,636 cap. Stagnation is a firing offense: idle capital enters early retirement via base-three half-life. 1 THD is always redeemable for 1 USDC. It encompasses Zeroth Theory (the philosophy), Crypto Fabric (the infrastructure), and The Human Dollar (the currency).',
            },
          },
          {
            '@type': 'Question',
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'The Human Dollar is money that works. Money is an employee — put it to work and earn $366 for every $1 at the 36,636 cap. Stagnation is a firing offense: idle capital enters early retirement. 1 THD is always redeemable for 1 USDC. This is Metabolic Reality, not speculation.',
            },
          },
          {
            '@type': 'Question',
  ...
  return (
    <>
      <Seo
        ...
        description="From enterprise architecture at JPMorgan and StoneX to building The Human Dollar (#THD). Money is an employee — $366 for every $1 put to work. Stagnation is a firing offense. Built on Zeroth Theory, Crypto Fabric, and The Human Dollar."
