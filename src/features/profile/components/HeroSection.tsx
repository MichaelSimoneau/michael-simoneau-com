    ...
    >
      ...
      >
        ...
        <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-8">
          Money is an employee. Put it to work and it pays you $655 for every $1 at the 65,535 cap. Stagnation is a firing offense — idle capital enters early retirement. This is not speculation. This is Metabolic Reality.
        </p>
      </motion.div>
