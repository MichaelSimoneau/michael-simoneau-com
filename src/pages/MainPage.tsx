...
const LazyVideoHeroSection = lazy(async () => ({
  default: (await import("../features/profile/components/VideoHeroSection"))
    .VideoHeroSection,
}));
const LazyMusicSection = lazy(async () => ({
  default: (await import("../features/profile/components/MusicSection"))
    .MusicSection,
}));
const LazyAIInterviewSection = lazy(async () => ({
  default: (await import("../features/interview/components/AIInterviewSection"))
    .AIInterviewSection,
}));
const LazyZeroHero = lazy(async () => ({
  default: (await import("../features/zero-truth/components/ZeroHero"))
    .ZeroHero,
}));
const LazyCryptoFabricHero = lazy(async () => ({
  default: (
    await import("../features/cryptofabric/components/CryptoFabricHero")
  ).CryptoFabricHero,
}));
          ...
          >
            <div className="container mx-auto">
              <h2 className="text-4xl font-bold text-white mb-12 text-center">
                The <span className="text-cyan-400">Credentials</span> That
