import { createCallout, createCode, createHeading, createList, createMath, createParagraph } from '../contentFactories';
...
export const blogData: BlogData[] = [
  {
    ...
    excerpt:
      "A full correction to binary duality: the 5-State Zeroth Law architecture defines deterministic convergence through Negative Zero (-0), Positive Zero (+0), Unsigned Zero (0), and realized state vectors.",
