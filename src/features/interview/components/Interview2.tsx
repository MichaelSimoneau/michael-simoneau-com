  ...
  return (
    <>
      ...
      <h2 className="text-2xl md:text-3xl mb-8 text-center font-bold">
        Session 2: From Code to Architecture
      </h2>

            <div className="space-y-8">
              <div className="bg-gray-900/50 p-6 rounded-lg">
                <h3 className="text-2xl font-bold mb-4 text-cyan-400">Interview Session 2: From Code to Architecture</h3>

                <div className="space-y-6">
                  <div>
                    <h4 className="text-lg font-semibold mb-2">When did you first think about building a factory instead of a boat?</h4>
                  ...
                  <div>
                    <h4 className="text-lg font-semibold mb-2">What is the EtherHive in that metaphor?</h4>
                  ...
                  <div>
                    <h4 className="text-lg font-semibold mb-2">Why funnel everything through a single central logic—the wizard? That sounds like a single point of failure.</h4>
                  ...
                  <div>
                    <h4 className="text-lg font-semibold mb-2">How does the factory talk to Ethereum?</h4>
                  ...
                  <div>
                    <h4 className="text-lg font-semibold mb-2">What happens if Ethereum gets congested or goes down?</h4>
                  ...
                  <div>
                    <h4 className="text-lg font-semibold mb-2">You mentioned the system &quot;filters reality.&quot; What does that mean?</h4>
