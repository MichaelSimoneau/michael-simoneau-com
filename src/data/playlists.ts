...
const melindaPodcasts: Record<string, string> = {
    "Michael Simoneau's Zeroth Theory Trap": "2026-03-04/Michael_Simoneau_s_Zeroth_Theory_Trap.mp3",
    "The Sysadmin Who Hacked His Therapist": "2026-03-04/The_Sysadmin_Who_Hacked_His_Therapist.mp3",
    "The Hostile Takeover of a Psychiatrist": "2026-03-04/The_Hostile_Takeover_Of_A_Psychiatrist.mp3",
}

const mainPodcasts: Record<string, string> = {
    "The Zeroth Theory of Digital Organisms": "2026-03-04/The_Zeroth_Theory_of_Digital_Organisms.mp3",
    "Tuesday Morning Brief - Good Morning Melinda": "2026-03-04/Tuesday_Morning_Brief__Good_Morning__Melinda.mp3"
}

const cleanPodcasts: Record<string, string> = {
    "Rewriting Einstein to Buy Your Milk": "2026-03-04/Rewriting_Einstein_to_buy_your_milk.mp3",
    "The Zeroth Theory of Digital Organisms": "2026-03-04/The_Zeroth_Theory_of_Digital_Organisms.mp3",
}

const podcastsToPlaylist = (podcasts: Record<string, string> | Track[]): Track[] => {
    return Object.entries(podcasts).map(([title, src]) => ({ title, src }));
};

const melindaPlaylist = podcastsToPlaylist(melindaPodcasts);
...
export { melindaPlaylist, cleanPlaylist, mainPlaylist };